            ...
            instace_groups += [
                {
                    ...
                    "EbsConfiguration": {
                        "EbsBlockDeviceConfigs": [
                            {"VolumeSpecification": {"SizeInGB": 100, "VolumeType": "gp2"}, "VolumesPerInstance": 1}
                        ],
                        "EbsOptimized": True,
                    },
                }
...
def lambda_handler(event, context):
    try:
        ...
        ssmresponse = ssm_client.get_parameter(Name="/SDLF/S3/ArtifactsBucket")
        artifacts_bucket = ssmresponse["Parameter"]["Value"]
        ssmresponse = ssm_client.get_parameter(Name="/SDLF/S3/CloudTrailBucket")
        ...
        response = emr_client.run_job_flow(
            ...
            Tags=[{"Key": "Role", "Value": "EMR Data Lake"}, {"Key": "Environment", "Value": env}],
