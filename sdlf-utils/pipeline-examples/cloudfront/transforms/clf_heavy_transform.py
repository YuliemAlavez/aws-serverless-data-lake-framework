...
class CustomTransform:
    ...
    def transform_object(self, bucket, keys, team, dataset):
        ...
        job_details = {
            ...
            "bootstrapActions": "s3://{}/{}/{}/elasticmapreduce/scripts/bootstrap.sh".format(
            ...
            "step1": [
                ...
                "--class",
                "dqs.DqsDriver",
                "s3://{}/{}/{}/elasticmapreduce/scripts/dqstest_2.11-1.0.jar".format(artifacts_bucket, team, dataset),
                "healthy",
                "2018-08-04",
            ...
            "step2": [
                ...
                "-d",
                "OUTPUT=s3://{}/{}/".format(bucket, processed_keys_path),
            ],
            "step3": [
                "hive-script",
                "--run-hive-script",
                "--args",
                "-f",
                "s3://{}/{}/{}/elasticmapreduce/scripts/clf_hive.q".format(artifacts_bucket, team, dataset),
                "-d",
                "INPUT=s3://{}/{}".format(bucket, keys[0].rsplit("/", 1)[0]),
                "-d",
                "OUTPUT=s3://{}/{}/".format(bucket, processed_keys_path),
            ],
        }
