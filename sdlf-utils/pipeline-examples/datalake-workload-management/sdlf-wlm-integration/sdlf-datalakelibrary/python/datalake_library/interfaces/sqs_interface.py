...
class SQSInterface:
    ...
    #--------------------------- 
    def wlm_receive_max_messages(self, messages, num_messages_queue):
        ...
        self._logger.info(f"max_batch_size: {max_batch_size}")
        ...
        self._logger.info(f"batch_sizes: {batch_sizes}")
