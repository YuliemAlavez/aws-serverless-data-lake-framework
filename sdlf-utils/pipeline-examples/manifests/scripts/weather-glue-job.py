...
args = getResolvedOptions(sys.argv, ["JOB_NAME", "SOURCE_LOCATION", "OUTPUT_LOCATION", "FILE_NAMES"])
...
for file in file_list.split("|"):
    weather_data = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": ["{}{}".format(source, file)]},
    ...
    weather_renamed.toDF().write.mode("append").parquet("{}/".format(destination))
