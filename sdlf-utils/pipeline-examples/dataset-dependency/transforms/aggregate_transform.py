...
class CustomTransform:
    ...
    def transform_object(self, bucket, keys, team, dataset):
        job_details = {"jobName": "test", "jobRunId": "test", "jobStatus": "STARTED"}

        response = {"processedKeysPath": "", "jobDetails": job_details}

        return response

    def check_job_status(self, bucket, keys, processed_keys_path, job_details):
        job_details = {"jobName": "test", "jobRunId": "test", "jobStatus": "SUCCEEDED"}
